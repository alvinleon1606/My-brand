document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        const response = await fetch(`https://NP Leon.onrender.com/blogs/${id}`);
        if (!response.ok) {
        ...
        singleBlogCard.innerHTML = `
            ...
            <img src="https://NP Leon.onrender.com/${blog?.userInfo.image}" alt="">
        ...
        likeButton.addEventListener('click', async () => {
            ...
            try {
                const response = await fetch(`https://NP Leon.onrender.com/blogs/blog/like/${id}`, {
                    method: 'PUT',
                    headers: {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch(`https://NP Leon.onrender.com/blogs/blog/comment/${id}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                    },
                ...
                const updatedBlogResponse = await fetch(`https://NP Leon.onrender.com/blogs/${id}`);
