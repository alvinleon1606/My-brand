document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        singleBlogCard.innerHTML = `
            ...
            <img src="https://leonx-ldu1-vvuz.onrender.com/${blog?.userInfo.image}" alt="">
        ...
        likeButton.addEventListener('click', async () => {
            ...
            try {
                const response = await fetch(`https://leonx-ldu1-vvuz.onrender.com/blogs/blog/like/${id}`, {
                    method: 'PUT',
                    headers: {
        ...
        form.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch(`https://leonx-ldu1-vvuz.onrender.com/blogs/blog/comment/${id}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                    },
                ...
                const updatedBlogResponse = await fetch(`https://leonx-ldu1-vvuz.onrender.com/blogs/${id}`);
