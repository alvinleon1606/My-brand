document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Fetch messages
    try {
        const messagesResponse = await fetch('https://leonx-ldu1-vvuz.onrender.com/messages/all', {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`,
            },
    ...
    // Fetch users
    try {
        const usersResponse = await fetch('https://leonx-ldu1-vvuz.onrender.com/users', {
            method: 'GET',
            headers: {
                'Authorization': `Bearer ${token}`,
            },
