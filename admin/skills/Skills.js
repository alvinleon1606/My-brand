document.addEventListener('DOMContentLoaded', function() {
    ...
    async function fetchSkills() {
        try {
            const response = await fetch('https://leonx-ldu1-vvuz.onrender.com/skills/all');
            if (!response.ok) {
    ...
    async function deleteSkill(id) {
        try {
            const response = await fetch(`https://leonx-ldu1-vvuz.onrender.com/skills/delete/${id}`, {
                method: 'DELETE',
                headers: {
