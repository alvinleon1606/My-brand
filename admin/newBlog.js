...
const deleteBlog = async (id) => {
    try {
        const response = await fetch(`https://leonx-ldu1-vvuz.onrender.com/blogs/delete/${id}`, {
            method: 'DELETE',
            headers: {
...
const displayBlogs = async () => {
    ...
    try {
        const response = await fetch('https://leonx-ldu1-vvuz.onrender.com/blogs/all');
        if (!response.ok) {
        ...
        blogs?.data.forEach((blog) => {
            ...
            blogsDiv.innerHTML = `
                ...
                <img src="https://leonx-ldu1-vvuz.onrender.com/${blog.image}" alt="" class="blog-img">
...
const CreateBlogs = async (formData) => {
    try {
        const response = await fetch('https://leonx-ldu1-vvuz.onrender.com/blogs/new', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${token}`,
            },
