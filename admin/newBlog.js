...
const deleteBlog = async (id) => {
    try {
        const response = await fetch(`https://leonx-ldu1.onrender.com/blogs/delete/${id}`, {
            method: 'DELETE',
            headers: {
    ...
    try {
        ...
        blogs?.data.forEach((blog) => {
            ...
            blogsDiv.innerHTML = `
                ...
                <img src="https://leonx-ldu1.onrender.com/${blog.image}" alt="" class="blog-img">
...
const CreateBlogs = async (formData) => {
    try {
        const response = await fetch('https://leonx-ldu1.onrender.com/blogs/new', {
            method: 'POST',
            headers: {
                'Authorization': `Bearer ${token}`,
            },
