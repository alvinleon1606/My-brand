document.addEventListener('DOMContentLoaded', function() {
    ...
    const displayProjects = async() => {
        ...
        try {
            const response = await fetch('https://leonx-ldu1.onrender.com/projects/all', {
                method: 'GET',
                headers: {
            ...
            img.src = `https://leonx-ldu1.onrender.com/${project.image}`
    ...
    function deleteProject(id) {
        fetch(`https://leonx-ldu1.onrender.com/projects/remove/${id}`, {
            method: 'DELETE',
            headers: {
                'Authorization': `Bearer ${token}`,
            },
