...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        const response = await fetch('https://leonx-ldu1-vvuz.onrender.com/messages/all', {
            method: 'GET',
            headers: {
        ...
        const displayMessages = () => {
            ...
            deleteButton.addEventListener('click', async (e) => {
                ...
                try {
                    const response = await fetch(`https://leonx-ldu1-vvuz.onrender.com/messages/delete/${message._id}`, {
                        method: 'DELETE',
                        headers: {
                            'Authorization': `Bearer ${token}`,
                        },
